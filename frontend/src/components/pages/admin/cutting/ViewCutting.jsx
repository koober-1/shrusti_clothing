...
const PaymentReceipt = forwardRef(({ paymentData, operatorEntries, receiptDetails }, ref) => {
  ...
  const styles = {
    ...
    advanceInfoSection: { // New style for advance balance display
        marginTop: "10px",
        paddingTop: "10px",
  ...
  return (
    <div ref={ref} style={styles.container}>
      ...
      {/* Advance Balance Info - Moved to a prominent spot above the work table */}
...
const ViewCutting = () => {
  ...
  const handlePrintEntries = () => {
    ...
    // const cuttingAvg = totalPieces > 0 ? (totalWeight / totalPieces) : 0; // Not used in print, but kept for context
